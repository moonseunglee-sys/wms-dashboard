...
function StatCard({ label, value, sub, color }: {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
      <p className="text-[11px] text-gray-400 font-medium uppercase tracking-wide mb-2">{label}</p>
      <p className="text-[22px] font-bold" style={{ color: color ?? '#1a1f2e' }}>{value}</p>
